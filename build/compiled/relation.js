...
class ActiveRelation {
    constructor(baseModel) {
        ...
        this._includes = [];
        this._where = [];
        this._proxify = { activeRelation: null, basePath: '' };
    ...
    async toArray() {
        try {
            const [rows] = await this.baseModel.connection.query(this.toSql(), this.toBindings());
    ...
    proxify(activeRelation, basePath) {
...
exports.default = ActiveRelation;
