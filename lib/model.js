...
function newModel({ className, connection }) {
    ...
    return _a = class DBSpecializedModel {
            constructor(id, editCommitId, editDate, notes) {
                this.id = id;
            ...
            static toObject(body, doJointure, exclude) {
                ...
                const obj = new Constructor(body[`${prefix}.id`], body[`${prefix}.editCommitId`], body[`${prefix}.editDate`], body[`${prefix}.notes`]);
